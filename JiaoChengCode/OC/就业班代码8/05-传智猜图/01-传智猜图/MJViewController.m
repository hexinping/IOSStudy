...
@interface MJViewController () <UIAlertViewDelegate>
- (IBAction)tip;
- (IBAction)bigImg;
- (IBAction)help;
...
//        
//        
//        UIAlertView *alert2 = [[UIAlertView alloc] initWithTitle:@"恭喜" message:@"通关了!!!!敬请期待!!!!" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"好的", nil];
//        alert2.tag = 20;
//        [alert2 show];
        return;
    }
